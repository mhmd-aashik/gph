    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      <div className="xl:w-1/2 flex-1 flex flex-col items-center justify-center text-center px-4 lg:px-0">
        ...
        <div className="flex items-center gap-1">
          ...
          />
          <Image
            src="https://cdn.freelogovectors.net/wp-content/uploads/2023/05/asian-paints_logo-freelogovectors.net_.png"
            alt="image1"
            width={100}
            height={200}
          />
      ...
      <div className="w-full py-4 border-t border-gray-300">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-center text-gray-600 text-sm md:space-x-8 space-y-1 md:space-y-0">
          ...
          >
            ...
            <span>074-297-8696</span>
          </a>
          <a
            href="https://mail.google.com/mail/u/0/#inbox?compose=GTvVlcRzBzFvgjjwPKQHbNtvlBjTJstgQCBXrsqwVbhKxbwNJPdWvxfGgnLjGHfkKlNpvJLnKvhJH"
            className="flex items-center space-x-1"
            target="_blank"
            title="Email"
          >
            ...
            <span>gallepaint@gmail.com</span>
          </a>
        </div>
      </div>
    </main>
